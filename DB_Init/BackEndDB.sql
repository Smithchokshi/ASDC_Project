...
CREATE TABLE IF NOT EXISTS `DataWiz`.`dashboard` (
    `dashboard_id` INT NOT NULL AUTO_INCREMENT,
    `user_id` INT NOT NULL,
    `vis1_id` INT NOT NULL,
    `vis2_id` INT DEFAULT NULL,
    `vis3_id` INT DEFAULT NULL,
    `vis4_id` INT DEFAULT NULL,
    `vis5_id` INT DEFAULT NULL,
    `vis6_id` INT DEFAULT NULL,
