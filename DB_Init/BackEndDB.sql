...
-- Schema BackEndDB
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `BackEndDB` DEFAULT CHARACTER SET utf8 ;
USE `BackEndDB` ;

-- -----------------------------------------------------
-- Table `BackEndDB`.`users`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `BackEndDB`.`connections`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `BackEndDB`.`connections` (
...
-- -----------------------------------------------------
-- Table `BackEndDB`.`visualizations`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `BackEndDB`.`visualizations` (
